...
All done using Binary Search. Based off my swift code for [Queenfisher](https://github.com/Ramdaniofficial/Queenfisher)

## Install

`npm i github:Ramdaniofficial/keyed-db`
...
``` ts
import KeyedDB from '@Ramdaniofficial/keyed-db'
