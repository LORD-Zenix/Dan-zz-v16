    ...
    return new Promise((resolve, reject) => {
        fetch('https://www.cademedia.com/jawaban-tebak-tebakan-asah-otak')
            ...
            .then(res => {
                ...
                // save json
                // fs.writeFileSync('./result/game/database/asahotak.json', JSON.stringify(data))
                resolve(data)
            }).catch(reject)
    })
}
            ...
            .then(res => {
                ...
                for (let i = 2; i < 350; i++) {
                    ...
                    if (i !== 21 && i !== 51 && i !== 101 && i !== 151 && i !== 201 && i !== 251 && i !== 301) {
                        ...
                        // save json
                        // fs.writeFileSync('./result/game/database/susunkata.json', JSON.stringify(data))
                    }
                }
                data.splice(0, 2)
                resolve(data)
        ...
        fetch('https://www.kabargames.id/kunci-jawaban-tebak-tebakan-2020')
            ...
            .then(res => {
                ...
                for (let i = 1; i < 201; i++) {
                    ...
                    // save json
                    // fs.writeFileSync('./result/game/database/tekateki.json', JSON.stringify(data))
                } resolve(data)
            }).catch(reject)
    })
}
